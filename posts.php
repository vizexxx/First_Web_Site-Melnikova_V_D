...
<?php
	echo "<h1 style='color:rgb(121, 102, 242);font-family: Rubik Bubbles;'>$title</h1>";
	echo "<p style='text-align:left;color:rgb(121, 102, 242);font-family: Comfortaa;'>$main_text</p>";
